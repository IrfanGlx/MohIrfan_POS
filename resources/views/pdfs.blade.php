...
<body>
	<center>
		<i>
			...
			<h4 style="margin-top: -25px;">Jl. Mayjend Sutoyo, Cawang, KramatJati</h4>
	...
	<div style="margin-left: 5px;">
		...
		<h4 style="margin-top: -20px;">Tahun 1997 SMEA Negeri 6 Jakarta berubah namanya menjadi SMK Negeri 10 Jakarta pada  tanggal 7 Maret 1997  berdasarkan Keputusan Menteri Pendidikan No.036/O/1997.</h4>
	</div>
	<table>
		<thead>
			<tr>
